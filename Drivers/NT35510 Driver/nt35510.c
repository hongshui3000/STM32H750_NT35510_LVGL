 ...
 * @retvalue   :None
******************************************************************************/
void HAL_NT35510_SRAM_Init(SRAM_HandleTypeDef* hsram)
{
...
void LCD_GPIOInit(FMC_NORSRAM_TimingTypeDef FWT)
{
	...
	HAL_NT35510_SRAM_Init(&SRAM_Handler);
}
...
//************* NT35510 flags **********//	
	...
	#if LCD_USE8BIT_MODEL	 //8О»ДЈКЅПВЈ¬LCDіхКј»ЇБЅ±йЈ¬·АЦ№reset»тХЯ¶ПµзЦШЖфєуЈ¬ПФКѕТміЈ
		if(init_flag==0)
		{
			init_flag=1;
			goto Init;
